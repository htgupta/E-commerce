                ...
                <div className=" mt-10 lg:mt-12 grid grid-cols-1 lg:grid-cols-3 gap-x-8 gap-y-10 lg:gap-y-0">
                    <div className="flex flex-col">
                        <div className="relative">
                            <img className="hidden lg:block" src="https://images.unsplash.com/photo-1602742159771-a37bb02328e8?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjM0fHxuaWtlJTIwc2hvZXN8ZW58MHx8MHx8fDA%3D" alt="bag" />
                    ...
                    <div className="flex flex-col">
                        <div className="relative">
                            <img className="hidden lg:block" src="https://images.unsplash.com/photo-1565571323165-ab0ee8e01666?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjQ1fHxuaWtlJTIwc2hvZXN8ZW58MHx8MHx8fDA%3D" alt="watch" />
                        ...
                        <div className="mt-6 flex justify-between items-center">
                            <div className="flex justify-center items-center">
                                <p className="tracking-tight text-2xl font-semibold leading-6 text-gray-800">Zx-3487</p>
                            </div>
                            <div className="flex justify-center items-center">
                    ...
                    <div className="flex flex-col">
                        <div className="relative">
                            <img className="hidden lg:block" src="https://images.unsplash.com/photo-1602751184857-4af984a8e19c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTgzfHxuaWtlJTIwc2hvZXN8ZW58MHx8MHx8fDA%3D" alt="shoes" />
